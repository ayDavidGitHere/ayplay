function AddGeos(scene, collideMeshList){
    this.object = this;
    /*
    var geosCustom = new GeosCustom(scene, collideMeshList, {GEN_GEO_COLOR: "red"})
    ...
    var orb = geosCustom_orb.createOrb( 
        ...
        {   type: "IcosahedronGeometry",
            add: true,
            material: new THREE.MeshPhongMaterial({ color: "#ff5231", opacity: 0.99, transparent: true, side: THREE.DoubleSide })
        },
    );
    ...
    mainLight.target.position.set( 200, 100, 200 );
