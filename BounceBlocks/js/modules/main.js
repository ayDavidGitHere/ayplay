...
function init() {
    ...
    hbtoControl = new HBTO_controlXYZ(camProps, "keyboarder", keyboard);
...
function heroBallSetDirection(){
    switch (hbtoControl.controlType){
        case "keyboarder":
            heroBall.travelOrientation = hbtoControl.keyboarded;
            switch (heroBall.travelOrientation) {
                case "-Z":
                    console.log(hbtoControl.keyboarderPM)
                    break;
                case "+Z":
                    console.log(hbtoControl.keyboarderPM)
                    break;
            }   
            heroBall.factorZ= (Math.sin(hbtoControl.keyboarderPM*Math.PI/180))
            heroBall.factorY = 1;
            heroBall.factorX = ( Math.cos( (180-hbtoControl.keyboarderPM)*Math.PI/180) )
        break;
        case "clicker":
