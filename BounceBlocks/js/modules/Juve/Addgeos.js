function AddGeos(scene, collideMeshList, STRUCTURE){
    ...
    let barrierBlockMaterial =  new THREE.MeshLambertMaterial({ color: "#333333",opacity: 0.45, transparent: false, side: THREE.BackSide });
    let barrierBlockGeo = new THREE.BoxGeometry(5, 10, 5);
    let barrierBlock = new THREE.Mesh(barrierBlockGeo, barrierBlockMaterial)
    scene.add(barrierBlock);
    this.barrierBlock = barrierBlock;
    
    
    let platformMaterial =  new THREE.MeshLambertMaterial({ color: "#ffffff",opacity: 0.45, transparent: false, side: THREE.BackSide });
    let platformGo = new THREE.BoxGeometry(STR.WID, STR.HEI, STR.LEN);
    let platformBlock = new THREE.Mesh(barrierBlockGeo, barrierBlockMaterial)
    ...
    function skyMaterial_ShadedColors(){
        ...
        "}";
        var skyBoxProps ={topColor: "white", bottomColor: "#FFB874"} 
