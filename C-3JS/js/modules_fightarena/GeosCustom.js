    ...
    let generalMaterial_Lambert = new THREE.MeshLambertMaterial({ color: GEN_GEO_COLOR, opacity: 0.45, transparent: false, side: THREE.DoubleSide });
    let generalMaterial_Phong = new THREE.MeshPhongMaterial({ color: GEN_GEO_COLOR,  side: THREE.DoubleSide });
    let generalMaterial = generalMaterial_Phong;
    
    
    let setGeneralMaterial = 
    function(genMaterial){generalMaterial = genMaterial;}
    ...
    this.createBLK = createBLK;
    this.createRamp =  createRamp;
    this.createOrb = createOrb;
    this.createTube = createTube;
    this.setGeneralMaterial = setGeneralMaterial;
