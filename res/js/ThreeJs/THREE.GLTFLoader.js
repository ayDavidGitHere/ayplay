 ...
 * @editor Ayoade /To allow non dracos.
 */
...
THREE.GLTFLoader = ( function () {
	...
	function GLTFDracoMeshCompressionExtension ( dracoLoader ) {
		...
		if ( ! dracoLoader ) {
            ...
            console.error("Dracoloader Error", 'THREE.GLTFLoader: No DRACOLoader instance provided.' );
            this.useable = false;
		}
        else{
		    this.useable = true;
	...
	GLTFParser.prototype.loadGeometries = function ( primitives ) {
		...
		return this.getDependencies( 'accessor' ).then( function ( accessors ) {
			...
			for ( var i = 0, il = primitives.length; i < il; i ++ ) {
				...
				} else if ( primitive.extensions && extensions[ EXTENSIONS.KHR_DRACO_MESH_COMPRESSION ].useable && primitive.extensions[ EXTENSIONS.KHR_DRACO_MESH_COMPRESSION ]  ) {
                    
                    console.log("we are using draco_mesh");
